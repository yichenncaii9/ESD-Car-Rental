# workers/twilio_wrapper/app.py — Phase 1 stub
import os
import time
...
print(f"[twilio_wrapper] Phase 1 stub started. Will connect to RabbitMQ at {RABBITMQ_HOST}:{RABBITMQ_PORT} exchange={EXCHANGE_NAME} in Phase 5.")
